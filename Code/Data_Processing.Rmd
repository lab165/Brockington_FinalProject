...
library(trend); library(sf); library(leaflet); library(mapview); library(dataRetrieval); library(ggspatial); library(rgdal)
...
ggplot() +
  geom_sf(data = CO_river_utm, col = "blue") +
  geom_sf(data = bat_data_sf_utm, col = "maroon") +
  geom_sf(data = CO_river_discharge_utm, col = "green")
