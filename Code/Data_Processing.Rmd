...
**Hypotheses**
1. Alt hypothesis: Temperature and prey availability significantly influenced bat activity along the Colorado River in the Grand Canyon.
...
bat_data_processed <-
  bat_data_raw %>%
  select(Date, LunarPhase, DailyTemp, Site, TotalCalls, AquaticPreyRate, TerrestrialPreyRate, TotalPreyRate)
...
```{r}
#exploring data
dim(bat_data_monthly)
summary(bat_data_monthly)
