...
**List of Figures**    
*Exploratory Analysis*    
-Figure \@ref(fig:map): Map of study area, Grand Canyon, AZ      
-Figure \@ref(fig:pairs): Pairs plot for all variables of interest      
-Figure \@ref(fig:discharge): Colorado River discharge over the course of the bat study (2017-2020)     
-Figure \@ref(fig:monthly): Mean monthly calls and mean monthly discharge across study timeline

*Analysis*      
-Figure \@ref(fig:residual): Residual plots to check the fit of the model     
-Figure \@ref(fig:temp): Temperature and number of bat calls        
-Figure \@ref(fig:veg): Vegetation cover and number of bat calls       
-Figure \@ref(fig:dis): Discharge and number of bat calls       
-Figure \@ref(fig:decomp): Decomposed components of the Colorado River discharge time series        
-Figure \@ref(fig:ns): Non-seasonal discharge for the Colorado River during the bat study (2017-2020)
...
```{r map, echo=FALSE, message=FALSE, warning=FALSE, fig.align="left", fig.width=9, fig.cap="Map of study area, Grand Canyon, AZ"}
bat_data_spatial <-
  bat_data_raw %>%
...
```{r pairs, echo=FALSE, message=FALSE, warning=FALSE, fig.align="left", fig.cap="Pairs plots for all variables of interest", fig.width=9}
...
```{r discharge, echo=FALSE, message=FALSE, warning=FALSE, fig.align="left", fig.cap="Colorado river discharge over the course of the bat study (2017-2020)", fig.width=9}
...
```{r monthly, echo=FALSE, message=FALSE, warning=FALSE, fig.align="left", fig.cap="Mean monthly calls and mean monthly discharge across study timeline", fig.width=9}
...
```{r residual, echo=F, warning=F, message=F, fig.cap="Residual plots to check the fit of the model", fig.width=9}
...
```{r temp, echo=F, warning=F, message=F, fig.cap="Temperature and number of bat calls", fig.width=9}
temp_calls_plot <- ggplot(daily_bat_discharge, aes(x = DailyTemp, y = TotalCalls)) +
  geom_point(size=1, alpha=0.7, color="steelblue4") +
  ylab("# of Bat Calls") +
  xlab("Daily Temperature (°C)") +
  geom_smooth(method = "lm", col = "palevioletred4", se = F)
print(temp_calls_plot)
```

```{r veg, echo=F, warning=F, message=F, fig.cap="Vegetation cover and number of bat calls", fig.width=9}
veg_calls_plot <- ggplot(daily_bat_discharge, aes(x = TallVeg, y = TotalCalls)) +
  geom_point(size=1, alpha=0.7, color="steelblue4") +
  ylab("# of Bat Calls") +
  xlab("Tall Vegetation Cover") +
  geom_smooth(method = "lm", col = "palevioletred4", se = F)
print(veg_calls_plot)
```

```{r dis, echo=F, warning=F, message=F, fig.cap="Discharge and number of bat calls", fig.width=9}
dis_calls_plot <- ggplot(daily_bat_discharge, aes(x = discharge, y = TotalCalls)) +
  geom_point(size=1, alpha=0.7, color="steelblue4") +
  ylab("# of Bat Calls") +
  xlab("Discharge (ft³/sec)") +
  geom_smooth(method = "lm", col = "palevioletred4", se = F)
print(dis_calls_plot)
```
...
```{r decomp, echo=F, warning=F, message=F, fig.cap="Decomposed components of the Colorado River discharge time series", fig.width=9}
...
```{r ns, echo=F, warning=F, message=F, fig.cap = "Non-seasonal discharge for the Colorado River during the bat study (2017-2020)", fig.width=9}
